<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar" style="font-family: Noto Sans Lao;">
                <div class="container-fluid navbar-inner">
                    <a href="./main.php" class="navbar-brand">
                        <h4 class="logo-title">ຮ້ານຄາເຟ່</h4>
                    </a>
                    ...
                    <h4 class="title text-primary">ໜ້າຫຼັກ</h4>
                                    ...
                                    <div class="card shadow-none m-0">
                                        <div class="card-header d-flex justify-content-between bg-primary py-3">
                                            <div class="header-title">
                                                <h5 class="mb-0 text-white">ຂໍ້ຄວາມທັງໝົດ</h5>
                                            </div>
                                        </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="sub-drop dropdown-menu dropdown-menu-end p-0" aria-labelledby="notification-drop">
                                    <div class="card shadow-none m-0">
                                        <div class="card-header d-flex justify-content-between bg-primary py-3">
                                            <div class="header-title">
                                                <h5 class="mb-0 text-white">ການແຈ້ງເຕືອນທັງໝົດ</h5>
                                            </div>
                                        </div>
                                        <div class="card-body p-0">
                                            <a href="#" class="iq-sub-card">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title">PX Developer</h6>
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item" href="./user-profile.php">ໜ້າໂປຣໄຟລ໌</a></li>
                                    <li><a class="dropdown-item" href="../dashboard/app/user-privacy-setting.html">ຕັ້ງຄ່າຄວາມເປັນສ່ວນຕົວ</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="./index.php">ອອກຈາກລະບົບ</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
