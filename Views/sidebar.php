                ...
                <ul class="navbar-nav iq-main-menu py-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                                ...
                                <img src="../assets/img/worker.png" alt="" width="20">
                            </i>
                            <span class="item-name">ຈັດການພະນັກງານ</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-parent">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="./user-add.php">
                                    ...
                                    <span class="item-name">ເພີ່ມພະນັກງານ</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="./user-list.php">
                                    ...
                                    <span class="item-name">ພະນັກງານທັງໝົດ</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#">
                            <i class="icon">
                              <img src="../assets/img/file.png" alt="" width="20">
                            </i>
                            <span class="item-name">ຈັດການເມນູສິນຄ້າ</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#">
                            <i class="icon">
                            <img src="../assets/img/delivery.png" alt="" width="20">
                            </i>
                            <span class="item-name">ຈັດການລາຍການສັ່ງຊື້</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="#">
                            <i class="icon">
                            <img src="../assets/img/inventory.png" alt="" width="20">
                            </i>
                            <span class="item-name">ຈັດການສິນຄ້າຄົງເຫຼືອ</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://templates.iqonic.design/lite/tecdig/html/dist/" target="_blank">
                            ...
                            <span class="item-name">ການຕັ້ງຄ່າ</span>
                        </a>
                    </li>
                </ul>
            </div>
